  ...
  return (
    <>
      <nav className="classic_navbar">
        {/*<Logo />*/}
        <Link className="classic_navbar_brand" to={'/'}>
          JustF0r
        </Link>
        <ul
          className={
            isActive ? 'classic_navbar_menu active' : 'classic_navbar_menu'
          }
        >
          <li className="classic_navbar_item">
            <Link className="classic_navbar_link" to={'/'}>
              Accueil
            </Link>
          </li>
          <li className="classic_navbar_item">
            <Link className="classic_navbar_link" to={'/Cocktail'}>
              Cocktail
            </Link>
          </li>
          <li className="classic_navbar_item">
            <Link className="classic_navbar_link" to={'/recipes'}>
              Recettes
            </Link>
          </li>
          <li className="classic_navbar_item">
            <Link className="classic_navbar_link" to={'/novels'}>
              Novel
            </Link>
          </li>
          <li className="classic_navbar_item">
